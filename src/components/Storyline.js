...
const API_KEY = "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";

const systemMessage = { 
  "role": "system", "content": "Speak like a narrator in an adventure genre story and always end your response with a question for the user to keep the story going."
}
  ...
  async function processMessageToChatGPT(chatMessages) { // messages is an array of messages
    ...
    await fetch("https://api.openai.com/v1/chat/completions", 
    {
      ...
      return data.json();
        ...
        console.log(data); // data.choices[0].message.content might be undefined if data is 0 hopefully this if check works
